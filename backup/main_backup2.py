...
#font_id = QFontDatabase.addApplicationFont("DefaultResources/DefaultFont2.ttf")
#DEFAULT_FONT = QFont(QFontDatabase.applicationFontFamilies(font_id)[0])
#DEFAULT_FONT = QFont()
...
class MainWindow (QMainWindow, user_interface):
    ...
    def objectAddedToScene(self, newObject):
        ...
        if itemTypeCount == 1:
            ...
            item.setText(newObject.name + " " + str(itemTypeCount))
        ...
        if event.mimeData().hasUrls:
            ...
            for url in event.mimeData().urls():
                ...
                if extension == ".png" or extension == ".jpg" or extension == ".jpeg" or extension == ".bmp":
                    ...
                    QFontDatabase.addApplicationFont(url.toLocalFile())
...
class Score(QGraphicsTextItem):
    ...
    def mySetFont(self, font: str):
        newFont = QFontDatabase().applicationFontFamilies(font)
